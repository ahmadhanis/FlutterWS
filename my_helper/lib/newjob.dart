...
class _CreateNewJobState extends State<CreateNewJob> {
          ...
          child: Row(
            children: <Widget>[
              ...
              new IconButton(
                  ...
                  onPressed: _changeLaundry),
              new IconButton(
                  iconSize: 40,
                  icon: new Icon(Icons.computer),
                  onPressed: _changeRepair),
              new IconButton(
                  iconSize: 40,
                  icon: new Icon(Icons.local_grocery_store),
                  onPressed: _changeShopping),
              new IconButton(
                  iconSize: 40,
  ...
  void _changeLaundry() {
    _jobcontroller.text = "Laundry";
  }

  void _changeRepair() {
    _jobcontroller.text = "Repair Computer";
  }

  void _changeShopping() {
    _jobcontroller.text = "Shopping";
  }

  void _changePickup() {
    _jobcontroller.text = "Pickup";
  }
}
